...
def EnterEmployeeInfo(employees, firstlist, secondlist, thirdlist, fourthlist, fifthlist, powerballlist):
  ...
  return employees, firstlist, secondlist, thirdlist, fourthlist, fifthlist, powerballlist


def PrintEmployeesInfo(employees):
...
def PrintWinningNumbers(firstlist, secondlist, thirdlist, fourthlist, fifthlist, powerballlist):
...
def main():
  ...
  while nextemployee.upper() == 'Y':
    ...
    # Function EnterEmployeeInfo is called to enter first and last name of employee and
    # lottery numbers for employee.  The function then updates the first thru fifth numbers and
    # powerball lists.  The function updates employee list with the employee's first and
    # last names and lottery numbers for employee. 
    EnterEmployeeInfo(employees, firstlist, secondlist, thirdlist, fourthlist, fifthlist, powerballlist)
  ...
  # Function PrintEmployeesInfo print out all the names and numbers entered for the employees 
  PrintEmployeesInfo(employees)

  # Function WinningNumbers generates lists for 1st, 2nd, 3rd, 4th, 5th numbers for 1 - 69 and
  # Powerball numbers for 1 - 26.  The function then print out the maximum selected powerball
  # numbers.  If there is a tie in the maximum selected numbers, then the maximum numbers are
  # randomly selected.
  PrintWinningNumbers(firstlist, secondlist, thirdlist, fourthlist, fifthlist, powerballlist)
